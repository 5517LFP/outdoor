...
<head>
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li>
							<a href="javascript:void(0)">项目检索</a>
						</li>
					</ul><!-- /.breadcrumb -->
									...
									<div class="col-xs-12">
										...
										<table width="100%" class="CSSearchTbl" cellpadding="0" cellspacing="0">
			                                <tr>
			                                    ...
			                                    <td class="left">内容检索：</td>
			                                    <td class="right"><input type="text" size="16" name="linecontent" /></td>
			                                    <td class="left">危险等级：</td>
			                                    <td class="right">
			                                    	<select id="myselectlvd" name="lvd">
			                                    ...
			                                    <td class="left">项目类型：</td>
			                                    <td class="right">
			                                    	<select id="myselecttype" name="type">
			                                    		<option  value="" >--请选择--</option>
			                                ...
			                                <tr>   	
			                                    <td class="left">强度等级：</td>
			                                    <td class="right">
			                                    	<select id="myselectlvs" name="lvs">
			                                    		<option  value="" >--请选择--</option>
	...
	<script type="text/javascript">
		...
		$("#tanchu").click(function(){
			...
			var inputlvs=document.getElementById('myselectlvs').value;
			var inputlvd=document.getElementById('myselectlvd').value;
			var inputcontent=$('input[name=content]').val();
			var inputtype= document.getElementById('myselecttype').value;
			...
			jQuery(grid_selector).jqGrid({
				//direction: "rtl",
				 ...
				 url : '${pageContext.request.contextPath}/project/projectserch.action', 
				postData:{name:inputname,lvs:inputlvs,lvd:inputlvd,content:inputcontent,type:inputtype},
				//subgrid options
				subGrid : true,
				mtype:"post",
				...
				colModel:[
					...
					{name:'pid',index:'pid', width:150, sortable:false,editable:true,hidden:true,key:true},
					{name:'name',index:'name', width:100, sorttype:"String", editable: true},
					{name:'lvs',index:'lvs',width:50, editable:true, sorttype:"String",edittype:"select",editoptions:{value:"0:0;1:1;2:2;3:3"}},
					{name:'lvd',index:'lvd', width:50,editable: true,edittype:"select",editoptions:{value:"A:A;B:B;C:C;D:D"}},
					{name:'type',index:'type', width:100,editable: true,edittype:"select",editoptions:{value:"sky:sky;ground:ground;water:water;all:all"}},
					{name:'content',index:'content', width:170, editable: true,edittype:"textarea", editoptions:{rows:"4",cols:"20"}},
				...
				editurl: "${pageContext.request.contextPath}/project/projectupdateandaddanddelete.action",//nothing is saved
				caption: "项目检索信息"
			}).trigger("reloadGrid");
