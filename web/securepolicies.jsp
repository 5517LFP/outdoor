		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					//direction: "rtl",
					 url : '${pageContext.request.contextPath}/secure/securelist.action', 
					...
					height: 250,
					colNames:[' ',' ','项目名称','等级区间','保险金额', '保险公司', '应交金额'],
					colModel:[
						...
						{name:'seid',index:'seid', width:60, sorttype:"int", editable: true,key:true,hidden:true},
						{name:'sename',index:'sename',width:90, editable:true},
						{name:'selv',index:'selv', width:150,editable: true},
						{name:'semoney',index:'semoney', width:70, editable: true},
						{name:'secompany',index:'secompany', width:90, editable: true},
						{name:'seneedmoney',index:'seneedmoney', width:150, sortable:false,editable: true} 
					], 
					...
					editurl: "${pageContext.request.contextPath}/secure/serureupdateanddelandadd.action",//nothing is saved
					caption: "保险信息表"
				});
