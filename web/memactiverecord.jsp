	...
	<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li>
							<a href="javascript:void(0)">报名管理</a>
						</li>
						<li>
							<a href="elements.html">会员活动记录</a>
						</li>
					</ul><!-- /.breadcrumb -->
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					//direction: "rtl",
					 url : '${pageContext.request.contextPath}/memberecord/memrecordlist.action', 
				...
				function gettypess(){
					...
					url:"${pageContext.request.contextPath}/member/memberlistsel.action",
