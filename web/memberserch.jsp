...
<head>
									...
									<div class="col-xs-12">
										...
										<table width="100%" class="CSSearchTbl" cellpadding="0" cellspacing="0">
			                                <tr>
			                                    ...
			                                    <td class="right"><input type="text"  size="16" name="hname" /></td>
			                                    <td class="left">身份证号：</td>
			                                    <td class="right"><input type="text" size="16" name="hidcard" /></td>
			                                    <td class="left">联系号码：</td>
			                                    <td class="right"><input type="text" size="16" name="hphonenumber" /></td>
			                                    <td class="left">冒险等级：</td>
			                                    <td class="right">
			                                    	<select id="myselect" name="hlv">
	...
	<script type="text/javascript">
		...
		$("#tanchu").click(function(){
			...
			$("#newone").slideDown("fast");
			var inputhname=$('input[name=hname]').val();
			var inputhphonenumber=$('input[name=hphonenumber]').val();
			var inputhidcard=$('input[name=hidcard]').val();
			
			var inputhlv= document.getElementById('myselect').value;
			...
			jQuery(grid_selector).jqGrid({
				//direction: "rtl",
				 url : '${pageContext.request.contextPath}/member/memberserch.action', 
				postData:{hname:inputhname,hphonenumber:inputhphonenumber,hidcard:inputhidcard,hlv:inputhlv},
				//subgrid options
				subGrid : true,
