		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					//direction: "rtl",
					 url : '${pageContext.request.contextPath}/fontbaoming/list.action?bbname=${sessionScope.user.hname}', 
					...
					height: 250,
					colNames:[' ',' ','会员名称','最近联系方式','活动名称', '活动时间', '审核状态'],
					colModel:[
						...
						{name:'bid',index:'bid', width:60, sorttype:"int", editable: true,key:true,hidden:true},
						{name:'bname',index:'bname',width:90},
						{name:'bphone',index:'bphone', width:150,editable: true},
						{name:'bactivename',index:'bactivename', width:70, editable: true,edittype:'select',editoptions:{value:gettypes()}},
						{name:'bactivetime',index:'bactivetime', width:90},
						{name:'bjust',index:'bjust', width:150, sortable:false,edittype:"select",editoptions:{value:"审批中:审批中;同意:同意;驳回:驳回"}} 
					], 
					...
					editurl: "${pageContext.request.contextPath}/fontbaoming/add.action?bbname=${sessionScope.user.hname}",//nothing is saved
					caption: "报名记录"
				});
