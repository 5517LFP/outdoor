...
<div class="container-fluid banner banbk">
  <iframe src="<%=basePath%>jq224909.jsp" width="100%" height="100%"></iframe>
	...
	<div class="banseo">
    	...
    	<form action="<%=basePath%>login/serch.action" method="post"><input type="text" name="serchtext"  class="bantxt" id="searchtxt" placeholder="输入想查询的内容.." onkeyup="autoComplete.start(event)"><button onclick="onserch();"  class="btn banbutt" type="submit" id="seobut" ><i class="fa fa-chevron-circle-right"></i> 找寻你足迹</button></form><span class="seoicn"><i class="fa fa-search"></i></span>
    </div>
        ...
        <div class="container m0 bod">      
                ...
                <div class="col-lg-4 col-md-3 col-sm-4" > 
                  ...
                  <div class="cover-stat">
                        ...
                        <div class="cover-yh">
                            <a href="<%=basePath%>font_baoming.jsp" data-container="body" data-toggle="popover" data-placement="top" data-content="点击报名">
