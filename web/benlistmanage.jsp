		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					//direction: "rtl",
					 url : '${pageContext.request.contextPath}/baoming/baominglist.action', 
					...
					height: 250,
					colNames:[' ',' ','会员名称','联系方式','活动名称', '活动时间', '审核状态'],
					colModel:[
						...
						{name:'bname',index:'bname',width:90, editable:true},
						{name:'bphone',index:'bphone', width:150,editable: true},
						{name:'bactivename',index:'bactivename', width:70, editable: true},
						{name:'bactivetime',index:'bactivetime', width:90, editable: true},
						{name:'bjust',index:'bjust', width:150, sortable:false,editable: true,edittype:"select",editoptions:{value:"审批中:审批中;同意:同意;驳回:驳回"}} 
					], 
					...
					editurl: "${pageContext.request.contextPath}/baoming/baomingupdate.action",//nothing is saved
					caption: "会员信息总览"
				});
